...
INSERT INTO `authors` (`auth_id`, `authFirstName`, `authLastName`, `authNatonality`, `createdAt`, `updatedAt`) VALUES
...
INSERT INTO `books_categorys` (`book_id`, `category_id`, `createdAt`, `updatedAt`) VALUES
...
INSERT INTO `categorys` (`category_id`, `categoryName`, `createdAt`, `updatedAt`) VALUES
...
ALTER TABLE `books`
  ...
  ADD KEY `auth_FK` (`auth_id`) USING BTREE;

--
-- Index pour la table `books_categorys`
--
ALTER TABLE `books_categorys`
  ADD KEY `category_id_book_id_FK` (`category_id`),
  ADD KEY `book_id_category_id_FK` (`book_id`);
...
--
ALTER TABLE `authors`
  MODIFY `auth_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT pour la table `books`
--
ALTER TABLE `books`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=701;
...
--
ALTER TABLE `books`
  ADD CONSTRAINT `auth_FK` FOREIGN KEY (`auth_id`) REFERENCES `authors` (`auth_id`);
